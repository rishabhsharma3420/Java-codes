...
public class GenericTree {
	...
	public boolean checkisomers(GenericTree one) {
		return this.checkisomers(one, root, false);
	}

	private boolean checkisomers(GenericTree one, Node node, boolean ans) {
		return ans;
	}

	private ArrayList<Node> getarr(Node node) {
		return node.child;
	}
